...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($cartItems) > 0) {
        foreach ($cartItems as $item) {
            ...
            $insertOrderSql = "INSERT INTO food_order (U_ID, FoodName, Quantity, Total, TimeStamp)
                               VALUES ('$u_id', '$foodName', '$quantity', '$grandTotal', NOW())";
            ...
            // $insertOrderSql = "INSERT INTO food_order (Order_ID, Total, TimeStamp, U_ID)
            //                     VALUES ('$Order_ID','$Total', '$TimeStamp', '$itemTotal', NOW())";
            // $conn->query($insertOrderSql);
        }
